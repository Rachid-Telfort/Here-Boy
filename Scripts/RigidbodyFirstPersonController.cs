...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            transform.position = areaMeshRenderer.bounds.center;
        }
        ...
        {
            ParticleSystem NPCParticlesSystem = NPCPArticles.GetComponent<ParticleSystem>();
            NPCParticlesSystem.transform.position = collisionGameObject.transform.position;
            NPCParticlesSystem.Play();
        ...
        void Whistle()
        {
            if (!hasWhistled)
            {
                ...
                {
                    //AudioController.getSingleton().PlaySFX(SFX_WHISTLE, transform.position,1,1,0);
